...
const ContentArea = ({ data, theme }) => {
  ...
  return (
    <motion.div variants={containerVars} initial="hidden" animate="visible" className="flex flex-col gap-6 w-full font-sans" id="home">
      ...
      {/* Work Experience & Certificates Row */}
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6" id="works">
            ...
            <div className="flex flex-col gap-4">
               {['Advanced ASP.NET Core Architecture', 'Azure Cloud Developer Associate'].map((cert, idx) => (
                 <div key={idx} className="flex items-center gap-4 bg-[#0E1018] p-4 rounded-2xl border border-white/5 cursor-pointer hover:border-blue-500/50 transition-colors">
                    <div className="w-10 h-10 rounded-lg bg-blue-500/10 flex flex-center text-blue-400 items-center justify-center shrink-0 font-bold">C</div>
        ...
        <motion.div variants={itemVars} className="p-8 rounded-[32px] shadow-lg flex flex-col h-full" style={{ backgroundColor: theme.cardBg, border: `1px solid ${theme.border}` }}>
          <div className="flex justify-between items-center mb-6">
            ...
            <a href="#" className="flex items-center gap-1 text-sm font-bold hover:underline text-[#4770FF]">
